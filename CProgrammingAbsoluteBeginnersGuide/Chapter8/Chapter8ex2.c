...
// C, 3rd Edition
// File Chapter8ex2.c
/* This is a sample program that asks users fro some basic data and prints it on screen in order to show what was entered */
...
main()
{
	...
	printf("Why not treat yourself to dinner on %d/%d/%d", month, day, year);
