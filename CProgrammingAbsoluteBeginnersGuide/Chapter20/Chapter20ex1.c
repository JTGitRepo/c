...
/* This program demonstratesthe math functions from the C math.h library, so that
 * you can get your homework right thanks to some quick-and-easy programming. */
