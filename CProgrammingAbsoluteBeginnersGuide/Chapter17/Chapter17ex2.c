...
#include <stdio.h>
#include <stdlib.h> // Remeber, if you plan to use exit(), you need
			// this header file
...
main()
{
	...
	// Despite being a long program, you only nedd two variables:
	...
	// resulting
	// information appear anre encased in a do-while loop that
	...
	do { 
		...
		switch (choice1)
		{
			...
			// is time to see what specific info they need
			case (1):
				{
					...
					{
						printf("/n/nOscar-Winning Movies in the 1980's:\n");
			...
			case (2):
				{
					...
					{
						printf("/n/nOscar-Winning Movies in the 1990's:\n");
			...
			case (3):
				{
					...
					if (choice2 == 1)
					{
						...
						printf("2001: Arizona Dianmondbacks\n");
						printf("2002: Anaheim Angels\n");
						printf("2003: Florica Marlins\n");
					...
					{
						printf("/n/nOscar-Winning Movies in the 2000's:\n");
